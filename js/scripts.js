$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '82513e56b96276584dc90b120216199d') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbxgGzRpMTBryYUoo5MZtu99BKqDTNwkaMJUi4JOUPxbmxQqhLK0rcz8M1CC9VvpyECsHQ/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Desculpe!</strong> Alguma coisa deu errada por aqui. '));
                });
        }
    });
    ...
    $('#btn-switch-view-to-old').click(function () {
        // Fade out the entire page using opacity
        $('body').css('transition', 'opacity 500ms ease-in-out').css('opacity', '0.3');
